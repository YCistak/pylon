...
export const iconWeather = `<svg role="img" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path d="M8 3v2M4.2 5.2l1.4 1.4M3 10h2M13.4 6.6l1.4-1.4M12 8a4 4 0 0 1 3.9 3.1A3.5 3.5 0 1 1 16 18H7a4 4 0 0 1-.9-7.9"/></svg>`
export const iconSysmon = `<svg role="img" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path d="M3 12h4l2 5 4-12 2 7h6"/></svg>`

// Now playing. Stroke style, matching iconWeather/iconSysmon rather than the
// brand marks: this card is about whatever is playing, not about one service.
export const iconMedia = `<svg role="img" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path d="M9 18V5l12-2v13"/><circle cx="6" cy="18" r="3"/><circle cx="18" cy="16" r="3"/></svg>`
